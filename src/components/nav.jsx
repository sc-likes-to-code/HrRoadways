...
import Login from "./Login";
import SignUpModal from "./SignUp";
// import ThemeToggle from "./ThemeToggle"; // ❌ Removed toggle usage
...
const Navigation = () => {
  ...
  const servicesDropdown = [
    ...
    { title: t("nav.schedule"), path: "/schedule" },
    { title: t("nav.tourGuide"), path: "/tour-guide" },
    { title: t("nav.travelPackages"), path: "/travel-packages" },
  ];
      ...
      >
        <div className="p-4 h-full overflow-y-auto">
          ...
          <ul className="space-y-4">
            ...
            {/* ❌ Theme toggle completely removed from mobile too */}
            ...
            <li className="relative">
              <button
                ...
                className="flex py-2 text-gray-700 hover:text-blue-600 items-center justify-between w-full dark:text-gray-200 dark:hover:text-blue-400"
              >
                {t("nav.services")}
                <ChevronDown
